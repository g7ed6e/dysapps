...
- **Créatures et carte en 3D** : la créature de chaque biome respire et tourne lentement dans sa bulle ; la carte de Blocland est un monde en 3D (une île par biome, décor, créature, ponts, îles verrouillées grisées) où l’on touche une île pour y entrer. La liste des biomes reste en dessous, en HTML accessible. Tout cela respecte « réduire les animations » et le réglage « Vues en 3D ».
