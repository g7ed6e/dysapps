...
- **Le continent qui monte** (`src/blocland/world/map.ts`, cadrage dans `docs/cadrage-monde.md`) : les vingt îles sont placées à la main sur une carte, chacune avec un cœur de 12 × 12 (plans, créature, décor) posé sur une terre plus large aux contours irréguliers, un relief (plat, collines, montagne enneigée) et une altitude qui monte avec la classe (6e au niveau de la mer, 3e sur les sommets). Les îles en altitude flottent sur une roche qui s'amincit ; les ponts deviennent des rampes à marches entre deux altitudes et contournent l'îlot du Gardien.
