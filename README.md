...
- **Le chantier** : on choisit une île ouverte, le panneau du plan montre le bâtiment en cours ; l'inventaire est affiché en lecture (les blocs servent aux plans et aux ponts). En 3D, on touche une case bleue du plan pour y poser le bloc attendu ; en vue simple (ou toujours), le bouton « Poser le bloc suivant ». Il n'y a plus de zone libre : la construction est entièrement guidée par les plans.
