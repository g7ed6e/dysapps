...
Ces règles s’appliquent à chaque exercice, du portail comme de Blocland. Elles ne sont pas des options : elles définissent ce qu’est un exercice DysApps. Les pages suivantes montrent, île par île, comment chaque quête les met en œuvre.

## Lire moins, mieux, ou autrement
